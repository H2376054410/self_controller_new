...
#define IMAGEPITCH_ZEROPOIN  -0.55f
#define IMAGEHIGH_ZEROPOIN  -0.55f

typedef struct
{
    float ImageYaw;   // 图传电机1
    float ImagePitch; // 图传电机2
    float ImageHigh;//控制图传电机高度的
} ImageMotor_s;
...
typedef __packed struct
{
    ...
    rt_uint8_t ImageHigh_Iflimit : 1;   
} Image_Limit_s;

/*控制角度限度*/
#define IMAGEYAW_ANGLEMAX 2.5f
#define IMAGEYAW_ANGLEMIN 0.5f
#define IMAGEPITCH_ANGLEMAX 2.0f
#define IMAGEPITCH_ANGLEMIN -2.8f
#define IMAGEHIGH_ANGLEMAX 0.1f
#define IMAGEHIGH_ANGLEMIN -170.1f
/**
 * @brief 机械限幅判断函数
...
//                              ForearmMotor_s *ForearmStateData,
