...
#define ARMPOS_INIT_Y 0.0f
#define ARMPOS_INIT_Z 0.0f
#define ARMPOS_INIT_YAW 0.0f
#define ARMPOS_INIT_PITCH 0.0f
...
/*机械臂银矿准备姿态*/
#define ARMPOS_SILVERINIT_X 0.06f
#define ARMPOS_SILVERINIT_Y 0.0f
#define ARMPOS_SILVERINIT_Z 0.30f
#define ARMPOS_SILVERINIT_YAW 0.0f
#define ARMPOS_SILVERINIT_PITCH -1.4f
#define ARMPOS_SILVERINIT_ROLL -0.00f

/*机械臂银矿上拔姿态*/
#define ARMPOS_SILVERPULLUP_X 0.06f
#define ARMPOS_SILVERPULLUP_Y 0.0f
#define ARMPOS_SILVERPULLUP_Z 0.38f
#define ARMPOS_SILVERPULLUP_YAW 0.0f
#define ARMPOS_SILVERPULLUP_PITCH -1.4f
...
/*机械臂正金矿准备姿态*/
#define ARMPOS_FRONTGOLDINIT_X 0.06f
#define ARMPOS_FRONTGOLDINIT_Y 0.0f
#define ARMPOS_FRONTGOLDINIT_Z 0.08f
#define ARMPOS_FRONTGOLDINIT_YAW 0.0f
#define ARMPOS_FRONTGOLDINIT_PITCH 0.30f
...
/*机械臂右侧金矿准备姿态*/
#define R_ARMPOS_SIDEGOLDINIT_X 0.10f
#define R_ARMPOS_SIDEGOLDINIT_Y 0.68f
#define R_ARMPOS_SIDEGOLDINIT_Z 0.37f
#define R_ARMPOS_SIDEGOLDINIT_YAW 1.02f
#define R_ARMPOS_SIDEGOLDINIT_PITCH -0.36f
#define R_ARMPOS_SIDEGOLDINIT_ROLL 0.60f
...
/*机械臂右侧金矿外拔姿态*/
#define R_ARMPOS_SIDE_GOLDPULLUP_X 0.15f
#define R_ARMPOS_SIDE_GOLDPULLUP_Y 0.59f
#define R_ARMPOS_SIDE_GOLDPULLUP_Z 0.45f
#define R_ARMPOS_SIDE_GOLDPULLUP_YAW 1.09f
#define R_ARMPOS_SIDE_GOLDPULLUP_PITCH -0.08f
#define R_ARMPOS_SIDE_GOLDPULLUP_ROLL 0.60f

/*机械臂金矿向外拔姿态*/
#define ARMPOS_FRONT_GOLDPULLUP_X 0.11f
#define ARMPOS_FRONT_GOLDPULLUP_Y 0.0f
#define ARMPOS_FRONT_GOLDPULLUP_Z 0.09f
#define ARMPOS_FRONT_GOLDPULLUP_YAW 0.0f
#define ARMPOS_FRONT_GOLDPULLUP_PITCH 0.28f
#define ARMPOS_FRONT_GOLDPULLUP_ROLL 0.00f

/*机械臂地上矿图传准备姿态*/
#define ARMPOS_FLOORIMAGEINIT_X 0.01f
#define ARMPOS_FLOORIMAGEINIT_Y 0.01f
#define ARMPOS_FLOORIMAGEINIT_Z 0
#define ARMPOS_FLOORIMAGEINIT_YAW 0
#define ARMPOS_FLOORIMAGEINIT_PITCH -0.93f
#define ARMPOS_FLOORIMAGEINIT_ROLL 0

/*机械臂吸取地上矿姿态*/
#define ARMPOS_FLOORINIT_X 0.01f
#define ARMPOS_FLOORINIT_Y 0.01f
#define ARMPOS_FLOORINIT_Z -0.05f
#define ARMPOS_FLOORINIT_YAW 0
#define ARMPOS_FLOORINIT_PITCH -0.8f
#define ARMPOS_FLOORINIT_ROLL 0

/*机械臂转矿上抬状态*/
#define ARMPOS_FLOORPULLUP_X 0.02f
#define ARMPOS_FLOORPULLUP_Y 0.02f
#define ARMPOS_FLOORPULLUP_Z 0.13f
#define ARMPOS_FLOORPULLUP_YAW 0
#define ARMPOS_FLOORPULLUP_PITCH -0.6f
#define ARMPOS_FLOORPULLUP_ROLL 0
...
/*存矿左侧*/
#define ARMPOS_STOCK_LEFT_X 0.05f
#define ARMPOS_STOCK_LEFT_Y 0.08f
#define ARMPOS_STOCK_LEFT_Z 0.15f
#define ARMPOS_STOCK_LEFT_YAW 1.4307f
#define ARMPOS_STOCK_LEFT_PITCH -0.15f
#define ARMPOS_STOCK_LEFT_ROLL 0.0f

/*存矿右侧*/
#define ARMPOS_STOCK_RIGHT_X 0.05f
#define ARMPOS_STOCK_RIGHT_Y -0.04f
#define ARMPOS_STOCK_RIGHT_Z 0.15f
#define ARMPOS_STOCK_RIGHT_YAW -1.4307f
#define ARMPOS_STOCK_RIGHT_PITCH 0.0f
#define ARMPOS_STOCK_RIGHT_ROLL 0.0f

/*自定义控制器准备姿态*/
#define ARMPOS_CUSTCTR_REDEY_X 0.06f
#define ARMPOS_CUSTCTR_REDEY_Y -0.06f
#define ARMPOS_CUSTCTR_REDEY_Z 0.297f
#define ARMPOS_CUSTCTR_REDEY_PITCH -0.75f
#define ARMPOS_CUSTCTR_REDEY_YAW 0.0f
#define ARMPOS_CUSTCTR_REDEY_ROLL 0.0f
#define ARMPOS_CUSTCTR_REDEY_MOVE 1.0f
...
#define GAIN_BOOM_REMOTE 0.000001f
/*小机械臂*/
