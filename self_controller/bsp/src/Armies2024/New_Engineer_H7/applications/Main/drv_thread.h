...
#define ROBOCTRL_TIMER_PIRIOD (4)   // 机器人控制周期
#define ROBOMOTOR_TIMER_PIRIOD (2)   // 机器人控制周期
...
#define THREAD_STACK_ArmMotorCtrl (2048) //机械臂电机控制线程
...
#define THREAD_PRIO_ArmCtrl (26)       // 机械臂控制线程
#define THREAD_PRIO_ArmMotorCtrl (25)  //机械臂电机控制线程
...
#define THREAD_TICK_ArmMotorCtrl (5) // 机械臂控制线程
