...
static int Engineer_Data_Init(void)
{
    ...
    Request_Add_Package("B_Pitch2_rad_now", strlen("B_Pitch2_rad_now"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    Request_Add_Package("B_Move_rad_now", strlen("B_Move_rad_now"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    /*小机械臂电机当前角度值 单位；*/
    ...
    Request_Add_Package("B_Pitch2_AngleNow", strlen("B_Pitch2_AngleNow"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    Request_Add_Package("B_Move_AngleNow", strlen("B_Move_AngleNow"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    /*矿石姿态相关数据*/
    Request_Add_Package("Gold_Roll_Hope", strlen("Gold_Roll_Hope"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    Request_Add_Package("Gold_Yaw_Hope", strlen("Gold_Yaw_Hope"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    Request_Add_Package("Gold_Pitch_Hope", strlen("Gold_Pitch_Hope"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));

    Request_Add_Package("Gold_Yaw_Now", strlen("Gold_Yaw_Now"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    Request_Add_Package("Gold_Roll_Now", strlen("Gold_Roll_Now"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    Request_Add_Package("Gold_Pitch_Now", strlen("Gold_Pitch_Now"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    ...
    Request_Add_Package("B_Pitch2_AngleHope", strlen("B_Pitch2_AngleHope"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    Request_Add_Package("B_Move_AngleHope", strlen("B_Move_AngleHope"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    ...
    Request_Add_Package("B_Pitch2_SpeedNow", strlen("B_Pitch2_SpeedNow"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    Request_Add_Package("B_Move_SpeedNow", strlen("B_Move_SpeedNow"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    ...
    Request_Add_Package("I_Pitch_AngleNow", strlen("I_Pitch_AngleNow"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    Request_Add_Package("I_High_AngleNow", strlen("I_High_AngleNow"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    /*图传云台电机当前角度值*/
    ...
    Request_Add_Package("I_Pitch_AngleHope", strlen("I_Pitch_AngleHope"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    Request_Add_Package("I_High_AngleHope", strlen("I_High_AngleHope"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    ...
    Request_Add_Package("I_Pitch_SpeedNow", strlen("I_Pitch_SpeedNow"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    Request_Add_Package("I_High_SpeedNow", strlen("I_High_SpeedNow"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    Request_Add_Package("Ihigh_CoderAngle", strlen("Ihigh_CoderAngle"),
                        &Engineer_RoboData, sizeof(Engineer_RoboData));
    /*图传云台当前角度值*/
