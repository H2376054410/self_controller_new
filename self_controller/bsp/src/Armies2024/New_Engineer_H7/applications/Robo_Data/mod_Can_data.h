...
rt_int16_t mouse_y; 
rt_int16_t mouse_z; 
rt_int8_t left_button_down; 
rt_int8_t right_button_down; 
rt_uint16_t keyboard_value; 
...
#define ImageYaw_MotorID 0x206     // 4
#define IMAGEYAW_EncoderID 0x204   // 5
#define IMAGEPITCH_EncoderID 0x204 // 5
#define IMAGEHIGH_EncoderID 0x201  // 5

#define BoomMove_MotorID 0x205 //
#define CUSTCTRL_YPR_ID 0x20A  // 自定义控制器yaw、pitch、roll报文ID处理
#define CUSTCTRL_XYZ_ID 0x20B  // 自定义控制器xyz报文ID处理

#define ForearmYaw_MotorID 0x208   // 1
#define ForearmPitch_MotorID 0x003 // 2
#define ForearmRoll_MotorID 0x002  // 3
#define ImagePitch_MotorID 0x207   // 4
#define ImageHigh_MotorID 0x208    //
...
#define IMAGE_CANID 0x1FF
#define BOOM_CANID 0x1FF
#define DEBUG_CANID 0x7FF
#define FOREARM_ROLL_CANID 0x002
#define FOREARM_PITCH_CANID 0x003
/**
 * @brief 从机1的报文发送处理函数
